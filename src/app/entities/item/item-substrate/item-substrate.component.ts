 ...
 */
@Component({
  selector: 'x-item-substrate',
  imports: [CommonModule],
  templateUrl: './item-substrate.component.html',
  styleUrl: './item-substrate.component.scss',
  encapsulation: ViewEncapsulation.Emulated,
})
export class ItemSubstrateComponent {
  private static __id: number = 0;
  private static get nextId() {
    const id = ItemSubstrateComponent.__id = ItemSubstrateComponent.__id + 1 === Number.MAX_SAFE_INTEGER ? 0 : ItemSubstrateComponent.__id + 1;
    return id;
  }
  ...
  constructor() {
    this._id = ItemSubstrateComponent.nextId;
