 ...
 */
@Component({
  selector: 'x-scroll-to-start-button',
  imports: [CommonModule, ButtonComponent],
  templateUrl: './scroll-to-start-button.component.html',
  styleUrl: './scroll-to-start-button.component.scss'
})
export class ScrollToStartButtonComponent {
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (!!contentEl && !!currentTheme) {
        const preset = this._themeService.getPreset(currentTheme.fileViewer.scrollToEndButton);
        if (!!preset) {
