# NgVirtualList File Viewer Demo

✨ NgVirtualList File Viewer Demo (ng-virtual-list-file-viewer) is an Angular-based showcase application designed to demonstrate high-performance rendering of long message history using virtual scrolling techniques.
...
[Live Demo](https://file-viewer.eugene-grebennikov.pro/)
...
```bash
git clone https://github.com/DjonnyX/ng-virtual-list-file-viewer.git
cd ng-virtual-list-file-viewer
```
